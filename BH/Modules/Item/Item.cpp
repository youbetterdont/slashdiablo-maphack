...
Patch* itemNamePatch = new Patch(Call, D2CLIENT, 0x96736, (int)ItemName_Interception, 6);
Patch* viewInvPatch1 = new Patch(Call, D2CLIENT, 0x997B2, (int)ViewInventoryPatch1_ASM, 6);
Patch* viewInvPatch2 = new Patch(Call, D2CLIENT, 0x98E84, (int)ViewInventoryPatch2_ASM, 6);
Patch* viewInvPatch3 = new Patch(Call, D2CLIENT, 0x97E3F, (int)ViewInventoryPatch3_ASM, 5);
