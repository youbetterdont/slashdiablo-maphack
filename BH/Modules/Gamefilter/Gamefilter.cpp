...
Patch* createGameBox = new Patch(Call, D2MULTI, 0xAD8F, (int)D2MULTI_CreateGameBox_Interception, 5);
Patch* destoryGameList = new Patch(Call, D2MULTI, 0x8413, (int)Gamefilter::DestroyGamelist, 5);
Patch* listRefresh = new Patch(Call, D2MULTI, 0x121EE, (int)D2MULTI_GameListRefresh_Interception, 5);
