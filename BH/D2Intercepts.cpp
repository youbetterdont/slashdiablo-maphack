...
void PositionMenuTab_Interception(void) {
	__asm
	{
		cmp eax, 03
		jne Mode640
		mov dword ptr ds:[0x6FAB0000+0x11D354], 352
		mov dword ptr ds:[0x6FAB0000+0x11D358], -110
		jmp RepositionEnd

Mode640:
		mov dword ptr ds:[0x6FAB0000+0x11D354], 0
		mov dword ptr ds:[0x6FAB0000+0x11D358], 0
