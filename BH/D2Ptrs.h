...
VARPTR(D2CLIENT, CropMode, DWORD, 0x11C414) //HDD2
VARPTR(D2CLIENT, MapPosX, DWORD, 0xF9E14) //HDD2
VARPTR(D2CLIENT, MapPosY, DWORD, 0xF9E18) //HDD2
VARPTR(D2CLIENT, SizeX1, DWORD, 0x11C230) //HDD2
VARPTR(D2CLIENT, SizeY1, DWORD, 0x11C234) //HDD2
VARPTR(D2CLIENT, SizeX2, DWORD, 0xDBC50) //HDD2 n
...
// HDD2 Related
FUNCPTR(D2CLIENT, ResizeDiablo, int __stdcall, (), 2ACF1)
FUNCPTR(D2WIN, SetResolutionMode, int __stdcall, (int), 0x17C00) //HDD2
