...
// HDD2 Tab Movement
VARPTR(D2CLIENT, TabXOffset, DWORD, 0x11B9A0)
VARPTR(D2CLIENT, TabYOffset, DWORD, 0x11B9A4)

ASMPTR(D2CLIENT, TabXOffset, 0x11B9A0)
ASMPTR(D2CLIENT, TabYOffset, 0x11B9A4)
