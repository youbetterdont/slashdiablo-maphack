...
VARPTR(D2CLIENT, CropMode, DWORD, 0x11D070)
VARPTR(D2CLIENT, MapPosX, DWORD, 0x123D64)
VARPTR(D2CLIENT, MapPosY, DWORD, 0x123D60)
VARPTR(D2CLIENT, SizeX1, DWORD, 0x11CF94)
VARPTR(D2CLIENT, SizeY1, DWORD, 0x11CF98)
VARPTR(D2CLIENT, SizeX2, DWORD, 0xF703C)

// HDD2 Tab Movement
VARPTR(D2CLIENT, TabXOffset, DWORD, 0x11D354)
VARPTR(D2CLIENT, TabYOffset, DWORD, 0x11D358)
VARPTR(D2CLIENT, InventoryArrangeMode, DWORD, 0x11D2B4)
VARPTR(D2CLIENT, TabYOffsetInstruction, BYTE, 0x1D417)
